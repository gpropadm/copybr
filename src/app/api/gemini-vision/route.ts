...
export async function POST(request: NextRequest) {
  try {
    ...
    if (body.prompt.includes('EXCLUSIVAMENTE em português brasileiro') || body.prompt.includes('prompt de texto abrangente e preciso') || body.prompt.includes('comprehensive, precise text prompt')) {
